<nav class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-2 shadow-sm sticky-top">
    <div class="container-fluid">
        <a class="navbar-brand me-5 fw-bold fs-3 h-font" href="index.php">SURYA HOTEL</a>
        <button class="navbar-toggler shadow-none" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item"><a class="nav-link active me-2" aria-current="page" href="index.php">Home</a>
                </li>
                <li class="nav-item"><a class="nav-link me-2" href="rooms.php">Rooms</a>
                </li>
                <li class="nav-item"><a class="nav-link me-2" href="facilities.php">Facilities</a>
                </li>
                <li class="nav-item"><a class="nav-link me-2" href="contact.php">Contact us</a>
                </li>
            ...
            <form>
                ...
                <div class="modal-body">
                    ...
                    <div
                        ...
                        <button type="submit"
                            class="btn btn-dark custom-bg shadow-none">LOGIN</button>
            ...
            <form>
                ...
                <div class="modal-body">
                    <span
                        ...
                        Note: Your details must match with your ID (Aadhaar
                        card,
                        passport, driving license, etch..)
                    ...
                    <div class="text-center my-1">
                        <button type="submit"
                            class="btn btn-dark custom-bg shadow-none">REGISTER</button>
                    </div>
                </div>
            </form>
        </div>
